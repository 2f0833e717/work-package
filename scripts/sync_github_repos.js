...
function enhanceDescription(repo) {
  ...
  if (description.split('\n').length < 3) {
    ...
    if (category === 'ポートフォリオ') {
      ...
      additionalInfo += `\n// AI拡充指示: GitHub「2f0833e717/${repo.name}」リポジトリについて、アクセス先の情報をWeb検索をして内容を分析し、このプロジェクトの目的や特徴について、概要と説明のセクションを編集し3行以内で簡潔に説明してください。`;
    } else if (category === '業務用ツール') {
      additionalInfo = `\nこのツールは業務効率化と自動化のために開発されました。`;
      additionalInfo += `\n// AI拡充指示: GitHub「2f0833e717/${repo.name}」リポジトリについて、アクセス先の情報をWeb検索をして内容を分析し、このツールの主な機能や用途について、概要と説明のセクションを編集し3行以内で簡潔に説明してください。`;
    } else if (category === '学習用リポジトリ') {
      additionalInfo = `\nこのリポジトリは技術学習と知識共有を目的としています。`;
      additionalInfo += `\n// AI拡充指示: GitHub「2f0833e717/${repo.name}」リポジトリについて、アクセス先の情報をWeb検索をして内容を分析し、このリポジトリで扱われている技術や学習内容について、概要と説明のセクションを編集し3行以内で簡潔に説明してください。`;
    }
